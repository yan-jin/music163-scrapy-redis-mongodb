...
class RedisSpiderSmartIdleClosedExtensions(object):
    ...
    def spider_idle(self, spider):
        ...
        if idle_list_len > 2 and self.idle_list[-1] - self.idle_list[-2] > 6:
            ...
            logger.info('\n continued idle number exceed {} Times\nmeet the idle shutdown conditions,'
                        '\nwill close the reptile operatiion\nidle start time: {}, close spider time: {}'
                        .format(self.idle_number, self.idle_list[0], self.idle_list[0]))
